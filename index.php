...
<html lang="en-US">
	<head>
		...
		<title>Peggy's veggie farm</title>
		<link rel="shortcut icon" type="image/x-icon" href="img/favicon.png" />

		<link href="css/master.css" rel="stylesheet">
		<link rel="stylesheet" href="css/customize_header.css">
		<!-- SWITCHER -->
		...
		<div class="b-page">
			...
			<header id="header">
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<div class="header-info">
								<!--<div class="description-header">
									Welcome to <span class = "color-primary">Peggy's veggie farm.</span>
								</div>-->
								<div>
									欢迎光临 <span class="color-primary">Peggy的蔬菜农场</span>
								</div>
							</div>
						</div>
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
							<a href="." class="btn extra-color pull-right">登录 | Login</a>
							<a class = "color-primary register">注册 | Register</a>
							
							<form class="form">
								<div class="switch-field">
									<div class="switch-title colar-primary">Language</div>
									<input type="radio" id="switch_left" name="switch_2" value="yes" checked/>
									<label for="switch_left">中文</label>
									<input type="radio" id="switch_right" name="switch_2" value="no" />
									<label for="switch_right">English</label>
								</div>
							</form>
				...
				<div class="header-nav">
					<div class="wrapper">
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 cart-block-r">
							<!-- shopping cart, no need for current version 
								
								<div class="cart-block pull-right">
								<i class="flaticon-shopping-bag1"></i>
								<div class="cart-box">
									<div class="cart-price pull-right">
										<span class="color-primary text-uppercase">Cart:</span>
						...
						<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 nav-box">
							...
							<nav class="nav-container">
								...
								<!--	<li class="search pull-right">
									...
									-->
									<li><a class="#" href="index.html">家庭菜场</a></li>
									<li><a class="#" href="about.html">湾区团购</a></li>
									<li><a class="#" href="#">餐馆订购</a></li>
									<li><a class="#" href="#">超市订购</a></li>
									<li><a class="#" href="shop.html">蔬菜介绍&烹饪</a></li>
									<li><a class="#" href="#">进出口贸易</a></li>
									<li><a class="#" href="blog.html">关于我们</a></li>
			...
			<div id="owl-home" class="owl-carousel owl-theme home-slider">
				...
				<div class="item">
					...
					<div class="wrapper s-custom">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<h1 class="s-custom-3">We Craft Your Garden<br />With Art & Beauty</h1>
				...
				<div class="item">
					...
					<div class="wrapper">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<h1>We Craft Your Garden<br />With Art & Beauty</h1>
							<div class="b-s-text">Lorem ipsum dolor sit amet consectetur adipisicing elit
				...
				<div class="item">
					...
					<div class="wrapper s-custom-2 s-content-center">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<h1 class="s-border">Make Your Lawns Verdant and Clean</h1>
							<div class="b-s-text">Our lawn mowing products are great, ensuring all areas
								mowed properly as our customer requirements</div>
							<div class="input-box in-home-slider">
								<button class="button-border text-uppercase">
									<span class="text-btn">HIRE US NOW</span>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="title-content-box hom-1 wow bounceInDown center">
								...
								<p>Lobortis fringilla felis usce voltpat mi aturna tnec quam vitae turpis ipsum</p>
							</div>
						</div>
					</div>
							...
							<div class="c-link-box wow rollIn">
								<a class="btn big-circle pull-right" href="#">
									<span class="c-content-block">
										...
										<span class="desc">Our Working Hours!</span>									</span>								</a>							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="c-link-box wow rollIn">
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 wow bounceInUp">
							<div class="allocated-block">
								...
								<h4>Consultation</h4>
								<div>Nam lobortis fringilla felis. Fusce vol utpat mi at urna. Cras ut nec quam vitae</div>
				...
				<div class="wrapper">
					...
					<div class="row-1 wow fadeInUp">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 hidden-xs hidden-sm">
							<img class="content-right-image" src="media/home/men.png" alt="men">						</div>
					</div>
				</div>
			</section>
			...
			<section class="gallery-box">
				...
				<div class="gallery-wrapper">
					<div class="g-row">
						...
						<div class="g-item">
							<img src="media/400x300/pr-2.jpg" alt="Recent Work">
							<div class="item-gallery-descr">
								<div class="btn-modal-box">
									<a class="btn-modal" href="media/400x300/pr-2.jpg" data-toggle="lightbox" data-title="Recent Work">
										<span class="ef icon_zoom-in"></span>
									</a>
						...
						<div class="g-item">
							<img src="media/400x300/pr-3.jpg" alt="Recent Work">
							<div class="item-gallery-descr">
								<div class="btn-modal-box">
									<a class="btn-modal" href="media/400x300/pr-3.jpg" data-toggle="lightbox" data-title="Recent Work">
										<span class="ef icon_zoom-in"></span>
									</a>
						...
						<div class="g-item">
							<img src="media/400x300/pr-4.jpg" alt="Recent Work">
							<div class="item-gallery-descr">
								<div class="btn-modal-box">
									<a class="btn-modal" href="media/400x300/pr-4.jpg" data-toggle="lightbox" data-title="Recent Work">
										<span class="ef icon_zoom-in"></span>
									</a>
					...
					<div class="g-row">
						<div class="g-item">
							<img src="media/400x300/pr-5.jpg" alt="Recent Work">
							<div class="item-gallery-descr">
								<div class="btn-modal-box">
									<a class="btn-modal" href="media/400x300/pr-5.jpg" data-toggle="lightbox" data-title="Recent Work">
										<span class="ef icon_zoom-in"></span>
									</a>
									<button type="button" class="btn-modal" data-toggle="modal" data-target="#myModal">
										<span class="ef icon_documents"></span>
						...
						<div class="g-item">
							<img src="media/400x300/pr-6.jpg" alt="Recent Work">
							<div class="item-gallery-descr">
								<div class="btn-modal-box">
									<a class="btn-modal" href="media/400x300/pr-6.jpg" data-toggle="lightbox" data-title="Recent Work">
										<span class="ef icon_zoom-in"></span>
									</a>
									<button type="button" class="btn-modal" data-toggle="modal" data-target="#myModal-2">
										<span class="ef icon_documents"></span>
						...
						<div class="g-item">
							<img src="media/400x300/pr-7.jpg" alt="Recent Work">
							<div class="item-gallery-descr">
								<div class="btn-modal-box">
									<a class="btn-modal" href="media/400x300/pr-7.jpg" data-toggle="lightbox" data-title="Recent Work">
										<span class="ef icon_zoom-in"></span>
									</a>
									<button type="button" class="btn-modal" data-toggle="modal" data-target="#myModal-3">
										<span class="ef icon_documents"></span>
						...
						<div class="g-item">
							<img src="media/400x300/pr-8.jpg" alt="Recent Work">
							<div class="item-gallery-descr">
								<div class="btn-modal-box">
									<a class="btn-modal" href="media/400x300/pr-8.jpg" data-toggle="lightbox" data-title="Recent Work">
										<span class="ef icon_zoom-in"></span>
									</a>
									<button type="button" class="btn-modal" data-toggle="modal" data-target="#myModal-4">
										<span class="ef icon_documents"></span>
				...
				<div class="wrapper">
					...
					<div class="row-1">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hidden-xs hidden-sm im-box">
							<img class="content-left-image" alt="girl" src="media/home/girl.png">						</div>
							...
							<div id="quote-olw-h1">
								  ...
								  <quote class="quote-block-2">
								    <div class="quote-wrap">
											<div class="quote-photo">
												<img class="#" alt="image" src="media/76x76/image2.jpg">											</div>
								...
								<div class="quote-box">
								  <quote class="quote-block-2">
								    <div class="quote-wrap">
											<div class="quote-photo">
												<img class="#" alt="image" src="media/76x76/image1.jpg">											</div>
											<div class="text-quote">
												<p>Nulla euismod malesuada nibh. Donec nunc. Praesent sit amet turpis eu nisl faucibus pharetra. Fusce quis neque vel leo semp er rhoncus. Ut interdum, risus id luctus consectetuer velit neq ue ornare quam beat ornare nisi velit nec turpis. Mauris lorem. Phasellus egestas urna vel sem. Ut auctor.</p>
											</div>
										</div>
					...
					<div class="wrapper">
						<div class="row-footer">
							<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 wow fadeInLeft">
								...
								<div class="f-b-box">
									<p>Neque arcu tincidunt neque pharetra code uct modo nibh leo non libero. Cras augues ipsum mpharetra inter sed. Integ er anterl nunc accumsan sed tempus rutrum.</p>
									...
									<div class="contact-f-wrapper">
										<div class="f-contact-box">
											...
											<span class="contact-info">
												380 Bell House Lane, Hill Station, AmazLand, CA 13579, USA
											</span>
										</div>
										<div class="f-contact-box">
											<span class="contact-name">
